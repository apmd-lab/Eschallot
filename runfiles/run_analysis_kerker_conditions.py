...
#identifier = 'kerker_conditions_dpsi90_lossy_Si_Schinke_rmax250_weights1000.0_0_1000.0'
identifier = 'kerker_conditions_dpsi45_lossy_Si_Schinke_rmax250_weights1000.0_0_1000.0'
...
with np.load(directory + '/topopt_result_' + identifier + '.npz') as data:
    ...
    #mat_profile = np.array(['Air','Si_Schinke','TiO2_Sarkar','Si_Schinke','Ag_palik','SiO2_bulk','Ag_palik','TiO2_Sarkar','Ag_palik'])
    mat_profile = np.array(['Air'] + ['Si_Schinke','Ag_palik']*5 + ['Si_Schinke','SiO2_bulk','Si_Schinke','TiO2_Sarkar','Si_Schinke'])
